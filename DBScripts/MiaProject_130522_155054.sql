...
alter table "APP"."PERSON_2"   add constraint FK_PERSON_2_CHAT_2_2 foreign key ("CHAT_2_OID") references "APP"."CHAT_2" ("OID");


-- participant2 [rel3]
alter table "APP"."PERSON_2"  add column  "CHAT_2_OID_2"  integer;
alter table "APP"."PERSON_2"   add constraint FK_PERSON_2_CHAT_2 foreign key ("CHAT_2_OID_2") references "APP"."CHAT_2" ("OID");
...
create table "APP"."PERSON_INTEREST_2" (
   ...
   "INTEREST_2_DESCRIPTION"  varchar(255) not null,
  primary key ("PERSON_2_OID", "INTEREST_2_OID", "INTEREST_2_DESCRIPTION")
);
...
alter table "APP"."PERSON_INTEREST_2"   add constraint FK_PERSON_INTEREST_2_INTEREST foreign key ("INTEREST_2_OID", "INTEREST_2_DESCRIPTION") references "APP"."INTEREST_2" ("OID", "DESCRIPTION");
