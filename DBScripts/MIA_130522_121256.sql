...
alter table "APP"."PERSON"   add constraint FK_PERSON_CHAT_2 foreign key ("CHAT_OID") references "APP"."CHAT" ("OID");


-- participant2 [rel3]
alter table "APP"."PERSON"  add column  "CHAT_OID_2"  integer;
alter table "APP"."PERSON"   add constraint FK_PERSON_CHAT foreign key ("CHAT_OID_2") references "APP"."CHAT" ("OID");
